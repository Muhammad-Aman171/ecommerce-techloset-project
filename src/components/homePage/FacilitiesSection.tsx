...
const FacilitiesSection = () => {
  return (
    <div className="flex flex-wrap justify-center items-center bg-[#E2F4FF] rounded-[20px] gap-y-[30px] gap-x-[104px] py-[44px] px-[118px] mx-[55px] mt-[75px] max-md:mt-0 max-md:w-full max-md:m-0 max-md:p-0 max-md:rounded-[0px] max-md:text-start max-md:py-[33px]  ">
      <FacilityCard
        srcImg={BoxImg}
